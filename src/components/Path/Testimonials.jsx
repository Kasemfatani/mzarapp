...
export default function Testimonials({ lang = "en", packageName }) {
	...
	return (
		...
		>
			...
			<br />
			<br />
			<div className="w-full rounded-[30px] overflow-hidden mb-10">
				<div
				...
				>
					...
					<div className="relative z-10 flex flex-col items-center justify-center py-12 px-4">
						<h2 className="text-3xl md:text-5xl font-bold text-white flex items-center justify-center gap-3 mb-6">
							{/* <span>
								<i className="fa-solid fa-kaaba text-4xl md:text-5xl align-middle" />
							</span> */}
							{language === "ar"
						...
						<p className="text-lg md:text-2xl text-white mb-8 max-w-2xl">
							{language === "ar" ? (
								<>
									احجز رحلتك الآن واستكشف المواقع المقدسة مع مزَار،
									<br className="hidden md:block" />
									رفيقك الذكي في كل خطوة من رحلتك.
								</>
							) : (
								<>
									Book your trip now and explore the sacred sites with Mazar,
									<br className="hidden md:block" />
									your smart companion every step of the way.
								</>
							)}
						</p>
