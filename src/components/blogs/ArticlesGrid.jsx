...
export function ArticlesGrid({ articles, isAr, BLOG_URL }) {
	const getFallbackImage = (imageName) => {
		const imageMap = {
			"mecca-landmarks":
				"https://images.unsplash.com/photo-1720549973451-018d3623b55a?w=800",
			"medina-mosque":
				"https://images.unsplash.com/photo-1692566123227-0f68f1b9dac6?w=800",
			"umrah-guide":
				"https://images.unsplash.com/photo-1571909552531-1601eaec8f79?w=800",
			"hira-cave":
				"https://images.unsplash.com/photo-1674313505558-206662f3de03?w=800",
			"visitor-tips":
				"https://images.unsplash.com/photo-1600383963284-91ef78fc9b6d?w=800",
			"quba-mosque":
				"https://images.unsplash.com/photo-1600383963284-91ef78fc9b6d?w=800",
			"tawaf-experience":
				"https://images.unsplash.com/photo-1571909552531-1601eaec8f79?w=800",
			"hijra-path":
				"https://images.unsplash.com/photo-1615380098674-d28bf1a87cd2?w=800",
			rawdah:
				"https://images.unsplash.com/photo-1765892272462-bad4a8ba0fb9?w=800",
			"uhud-mountain":
				"https://images.unsplash.com/photo-1674313505558-206662f3de03?w=800",
			"spiritual-preparation":
				"https://images.unsplash.com/photo-1665627394215-36d931bb8db7?w=800",
			"baqi-cemetery":
				"https://images.unsplash.com/photo-1600383963284-91ef78fc9b6d?w=800",
		};
								...
								<img
									src={
										article.featuredImage
											...
											: getFallbackImage(article.image)
									}
									alt={article.title}
								...
								<div className="flex items-center justify-between border-t border-[#e2e8f0] pt-4">
									<div className="flex items-center gap-4 text-base text-[#718096]">
										<div className="flex items-center gap-1.5">
											...
											<span>
												{article.readTime} {isAr ? "دقائق" : "minutes"}
											</span>
										</div>
										<div className="flex items-center gap-1.5">
