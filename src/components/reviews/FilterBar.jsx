...
import { ratingFilters, cities, tourTypes, sortOptions } from './reviews';
      ...
      <div className="container mx-auto max-w-7xl px-6 py-6 lg:px-8">
        <div className="mb-4 flex items-center justify-between">
          <p className="text-lg text-[#718096]">
            <span className="text-[#3C6652]">{totalResults}</span> نتيجة
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="relative">
            <label className="mb-2 block text-base text-[#4a5568]">التقييم</label>
            <div className="relative">
              <select
                value={rating}
              ...
              <ChevronDown className="pointer-events-none absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-[#718096]" />
            </div>
          </div>

          {/* City Filter */}
          <div className="relative">
            <label className="mb-2 block text-base text-[#4a5568]">المدينة</label>
            <div className="relative">
              <select
                value={city}
          ...
          {/* Tour Type Filter */}
          <div className="relative">
            <label className="mb-2 block text-base text-[#4a5568]">نوع الجولة</label>
            <div className="relative">
              <select
                value={tourType}
          ...
          {/* Sort By */}
          <div className="relative">
            <label className="mb-2 block text-base text-[#4a5568]">ترتيب حسب</label>
            <div className="relative">
              <select
                value={sortBy}
