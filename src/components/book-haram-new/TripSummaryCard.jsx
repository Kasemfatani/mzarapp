	...
	return (
		<div className="bg-white rounded-[20px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] border-[0.8px] border-[rgba(243,244,246,0.6)] overflow-hidden ">
			...
			<div className="relative h-[256px] w-full">
				...
				{/* Rating Badge */}
				<div className="absolute top-6 left-2 bg-[rgba(255,255,255,0.95)] rounded-full shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] px-2 py-0 flex items-center gap-1 text-sm">
					<Star
						className="w-5 h-5 fill-[#FDC700] text-[#FDC700]"
						strokeWidth={1.67}
					/>
					<p className="text-[#101828]">{rating}</p>
					<p className="text-[#4a5565] text-sm">
						({reviewCount} {isAr ? "تقييم" : "reviews"})
					</p>
				</div>
			</div>
			...
			<div className="px-4 py-6 flex flex-col gap-4">
				<div className="flex flex-col gap-2  ">
					<h2 className="text-[#3c6652] text-[30px] tracking-[-0.45px]">
						{title}
					</h2>
				...
				<div className="flex gap-4 justify-center">
					...
					<div className="w-3/6 md:w-auto bg-gradient-to-r from-[rgba(231,211,175,0.3)] to-[rgba(231,211,175,0.2)] border-[0.8px] border-[rgba(231,211,175,0.6)] rounded-full px-[16.8px] py-[4.8px] flex items-center gap-1">
				...
				<div className="relative h-[25.6px] w-full">
					...
					<div className="absolute left-1/2 -translate-x-1/2 top-0 bg-white px-2">
						<p className="text-[#6a7282] uppercase tracking-[0.8px]">
				...
				{/* Pricing Box */}
				<div
					className="relative rounded-[18px] border-[1.6px] border-[rgba(231,211,175,0.6)] overflow-hidden"
					style={{
						backgroundImage:
				...
				>
					<div className="flex justify-center items-center px-4 py-3 gap-2 text-sm">
						<p className="text-[#3c6652] text-center">
							...
							<span className="text-[#867957]">
								{isAr ? "حد أدنى" : "Minimum"} {minPeople}{" "}
								{isAr ? "أشخاص" : "people"}
							</span>
							)
						</p>
