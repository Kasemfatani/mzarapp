...
export default function KnowledgeBanner({ lang = "ar" }) {
	return (
		<section className="w-full bg-[#f6f1e7] py-8 px-2 flex justify-center">
			<div
				className="relative w-full max-w-5xl rounded-3xl overflow-hidden flex items-center justify-center min-h-[260px] sm:min-h-[320px] md:min-h-[360px]"
				style={{
				...
				<div className="relative z-10 flex flex-col items-center justify-center w-full h-full text-center px-4">
					...
					<p className="text-white text-base md:text-lg font-medium mb-1">
						{lang === "ar"
							...
							: "Mzar in collaboration with the Royal Commission for Makkah City and Holy Sites"}
					</p>
					<p className="text-white text-base md:text-lg font-medium">
						{lang === "ar"
							? "لإثراء تجربة الزائر في أقدس بقاع الأرض"
							: "To enrich the visitor experience in the holiest places on earth"}
					</p>
				</div>
			</div>
		</section>
