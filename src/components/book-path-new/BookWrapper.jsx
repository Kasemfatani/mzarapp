		...
		form.handleSubmit(
			async (values) => {
				try {
					...
					// Apply 5% discount if paying online (At Start Method)
					if (method === "online") {
						// 1. Discount on pre-tax
						const onlineDiscount = Number((totalBeforeTax * 0.05).toFixed(2));
						// 2. New Taxable
						const onlineTaxable = Number((totalBeforeTax - onlineDiscount).toFixed(2));
						// 3. New Tax
						...
						console.log(
							...
							"Old Total:", (totalBeforeTax + taxAmount).toFixed(2),
