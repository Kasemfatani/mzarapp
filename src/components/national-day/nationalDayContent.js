...
export function getNationalDayContent(isAr) {
	if (isAr) {
		return {
			...
			booking: {
				...
				quantityHint: "يمكن حجز 25 مقعدًا كحد أقصى في الطلب الواحد.",
				...
				quantityInvalid: "اختر عدد مقاعد من 1 إلى 25.",
	...
	return {
		...
		title: "Reserve your seat",
			...
			quantityHint: "You can book up to 25 seats in one order.",
			...
			quantityInvalid: "Choose between 1 and 25 seats.",
