...
export function PriceCalculationBox({
  ...
  return (
    ...
    >
      {/* Decorative circles */}
      <div className="absolute -top-20 right-[621.6px] w-40 h-40 bg-[rgba(231,211,175,0.03)] rounded-full" />
      <div className="absolute top-[122.4px] -left-24 w-48 h-48 bg-[rgba(60,102,82,0.05)] rounded-full" />
      ...
      <div className="relative p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4">
            <div className="flex flex-col items-start ">
              <h3 className="text-[#3c6652] text-2xl tracking-[-0.24px]">ملخص الأسعار</h3>
              <p className="text-[#4a5565]">يتم التحديث تلقائياً</p>
            </div>
            <div className="bg-gradient-to-b from-[#3c6652] to-[#2d4d3d] rounded-full shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] w-14 h-14 flex items-center justify-center">
          ...
          <Sparkles className="hidden md:block w-6 h-6 text-[#867957]" strokeWidth={2} />
        </div>
        ...
        <div className="px-6 flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between border-b border-[#e6d2af] pb-4 pt-4">
            <p className="text-[#364153]">سعر الفرد</p>
            <div className="flex items-center gap-2">
              {/* Currency Icon */}
              <p className="text-[#1e2939] rtl">{pricePerPerson} {CURRENCY_SVG}</p>
            </div>
          ...
          {/* Minimum booking */}
          <div className="flex items-center justify-between border-b border-[#e6d2af] pb-4 pt-4">
            <p className="text-[#364153]">الحد الأدنى للحجز</p>

            <div className="flex items-center gap-3">
              <TrendingUp className="w-5 h-5 text-[#867957]" strokeWidth={1.67} />
              <p className="text-[#867957]">× {numberOfPeople}</p>
            </div>
          ...
          {/* Total price */}
          <div className="flex items-center justify-between border-b border-[#e6d2af] pb-4 pt-4">
            <p className="text-[#364153]">إجمالي السعر</p>
            <div className="flex items-center gap-2">
              {/* Currency Icon */}
              <p className="text-[#1e2939] rtl">{totalPrice} {CURRENCY_SVG}</p>
            </div>
            
          </div>

          {/* Final total */}
          <div className="bg-gradient-to-b from-[#3c6652] to-[#2d4d3d] rounded-[18px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] px-6 py-4 flex items-center justify-between">
            <div className="flex flex-col items-start ">
              <p className="text-[rgba(255,255,255,0.8)]">المجموع النهائي</p>
              <p className="text-[rgba(255,255,255,0.6)] text-sm">شامل جميع الرسوم والضرائب</p>
            </div>

            <div className="flex items-center gap-2">
              {/* Currency Icon */}
              <p className="text-white rtl">{totalPrice} {CURRENCY_SVG}</p>
            </div>
          ...
          <div className="bg-[#f0fdf4] border-[0.8px] border-[#b9f8cf] rounded-[16.4px] px-6 py-2 flex items-center  gap-2">
            <p className="text-[#4a5565]">السعر نهائي بدون أي رسوم إضافية مخفية</p>
