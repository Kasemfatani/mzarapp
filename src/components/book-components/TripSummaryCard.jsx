  ...
  return (
    <div className="bg-white rounded-[20px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] border-[0.8px] border-[rgba(243,244,246,0.6)] overflow-hidden ">
      ...
      <div className="relative h-[256px] w-full">
        ...
        {/* Location Badge */}
        <div className="absolute top-6 right-4 bg-[rgba(255,255,255,0.95)] rounded-[20px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] px-2 py-0 flex items-center gap-2">
