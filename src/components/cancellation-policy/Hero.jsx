...
export function Hero({ isAr }) {
	const trustBadges = [
		...
		{
			icon: CheckCircle2,
			text: isAr ? "استرجاع منظم وفق الشروط" : "Organized Refund Process",
		},
	];
	...
	return (
		<section className="relative overflow-hidden bg-gradient-to-br from-[#0d5940] via-[#116149] to-[#0d5940] py-20 md:py-32">
			...
			<div className="absolute inset-0 ">
				<Image
					src="/cancellation/cancellation-hero.webp"
					alt="Cancellation Policy Background"
			...
			<div className="container relative mx-auto max-w-6xl px-6 lg:px-8">
				...
				<div className="mb-8 text-center">
					...
					<p className="mx-auto max-w-3xl text-2xl leading-relaxed text-white/95 md:text-3xl">
						{isAr
							? "حجزك معنا آمن ــ إجراءات واضحة لضمان تجربة مريحة "
							: "Your booking is secure – clear procedures to ensure a smooth experience."}
					</p>
				</div>
