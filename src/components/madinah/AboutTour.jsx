...
const features = [
	{
		...
		ar: "مدة الرحلة",
		en: "Duration",
		valueAr: "90 دقيقة من السكينة والمعرفة",
		valueEn: "90 minutes of peace and knowledge",
	},
	{
		icon: "fa-solid fa-user-group",
		ar: "الفئة",
		en: "Category",
		valueAr: "متاحة للرجال فقط (حسب التنظيم)",
		valueEn: "Available for men only (as per regulations)",
	},
	{
	...
	},
	{
		...
		ar: "المحتوى",
		en: "Content",
		valueAr: "قصص موثقة وسرد تاريخي تفاعلي",
		valueEn: "Content Verified stories and interactive historical narration",
	},
	{
