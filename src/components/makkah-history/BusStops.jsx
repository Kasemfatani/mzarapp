...
export default function BusStops({ lang = "en" }) {
	...
	const t = useMemo(
		() => ({
			headline: isAr
				? " ما الذي ستتعلّمه من التجربة؟"
				: "What will you learn from the experience?",

			smallText: isAr
				? "كل موقع تحكيه لك التقنية بالصوت والصورة من قلب الحدث"
				: "Each site is narrated to you through audio and visuals from the heart of the event",
