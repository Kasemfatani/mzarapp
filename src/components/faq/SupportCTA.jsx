    ...
    <section className="bg-white py-20 md:py-28">
      <div className="container mx-auto max-w-4xl px-6 text-center lg:px-8">
        ...
        <div className="flex flex-col justify-center gap-5 sm:flex-row">
          <button className="group flex items-center justify-center gap-3 rounded-full bg-[#0d5940] px-10 py-5 text-xl text-white transition-all duration-300 hover:bg-[#116149] hover:shadow-xl">
            <span>{isAr ? "تواصل معنا" : "Contact Us"}</span>
            <Mail className="h-6 w-6 transition-transform group-hover:translate-x-1" />
          </button>

          <button className="flex items-center justify-center gap-3 rounded-full border-2 border-[#0d5940] bg-transparent px-10 py-5 text-xl text-[#0d5940] transition-all duration-300 hover:bg-[#0d5940] hover:text-white hover:shadow-xl">
