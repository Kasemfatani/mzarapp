	...
	return (
		<section className="relative bg-[rgba(133,120,86,0.7)] py-12 md:py-24 flex items-center justify-center overflow-hidden" >
            ...
            {isAr ? "تجربة المسجد الحرام الإثرائية " : "Al-Masjid Al-Haram Enrichment Experience"}
					...
					>
						{isAr ? "تجربة تأخذك بين قدسية المكان وعبق التاريخ ــ ابدأ تجربتك الآن! " : "An experience that takes you between the sanctity of the place and the fragrance of history ــ start your experience now! "}
					</p>
