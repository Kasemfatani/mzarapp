	...
	const tours = [
		{
			...
			title: isAr ? "جولة المسجد الحرام الشاملة" : "Comprehensive Masjid al-Haram Tour",
			location: isAr ? "مكة المكرمة" : "Mecca",
			description:
				isAr ? "استكشف تاريخ وعمارة المسجد الحرام مع مرشد متخصص، وتعرف على أهم المعالم التاريخية والدينية" : "Explore the history and architecture of Masjid al-Haram with a specialized guide, and learn about the most important historical and religious landmarks",
			price: "199",
			rating: 5,
			reviews: 342,
			duration: 4,
		...
		},
		{
			...
			title:  isAr ? "جولة المسجد النبوي والمعالم التاريخية" : "Prophetic Mosque and Historical Sites Tour",
			location: isAr ? "المدينة المنورة" : "Medina",
			description:
				isAr ? "زيارة المسجد النبوي الشريف والتعرف على السيرة النبوية من خلال المواقع التاريخية" : "Visit the Prophet's Mosque and learn about the prophetic biography through historical sites",
			price: "179",
			rating: 5,
			reviews: 287,
			duration: 5,
		...
		},
		{
			...
			title:  isAr ? "رحلة المعالم الدينية الكاملة" : "Complete Religious Sites Tour",
			location: isAr ? "مكة المكرمة" : "Mecca",
			description:
				isAr ? "جولة شاملة تشمل غار حراء، جبل النور، مسجد التنعيم وأهم المواقع الإسلامية" : "A comprehensive tour including Cave of Hira, Mount Noor, Masjid Al-Taneem, and important Islamic sites",
			price: "249",
			rating: 5,
			reviews: 521,
			duration: 7,
		...
		},
		{
			...
			location: isAr ? "المدينة المنورة" : "Medina",
			description:
				isAr ? "زيارة جبل أحد والتعرف على أحداث غزوة أحد التاريخية مع مرشد متخصص" : "Visit Mount Uhud and learn about the historical events of the Battle of Uhud with a specialized guide",
			price: "159",
			rating: 4,
			reviews: 210,
			duration: 3,
		...
		},
		{
			...
			location: isAr ? "المدينة المنورة" : "Medina",
			description:
				isAr ? "زيارة أول مسجد بني في الإسلام والتعرف على تاريخه وأهميته الدينية" : "Visit the first mosque built in Islam and learn about its history and religious significance",
			price: "129",
			rating: 4,
			reviews: 180,
			duration: 2,
		...
		},
		{
			...
			location: isAr ? "مكة المكرمة" : "Mecca",
			description: isAr ? "استكشاف معالم مكة القديمة والأسواق التاريخية مع مرشد محلي" : "Explore the old landmarks of Mecca and historical markets with a local guide",
			price: "189",
			rating: 5,
			reviews: 300,
			duration: 5,
		...
		<section className="py-20 bg-gradient-to-b from-white to-[#E7D3AF]/10">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="text-center mb-12">
					...
					>
						{isAr ? "اختر جولتك المفضلة" : "Choose Your Favorite Tour"}
					</h2>
					<p
					...
					>
						{isAr
							? "تجارب مختارة بعناية لتناسب جميع الزوار"
							: "Carefully selected experiences for all visitors"}
					</p>
				</div>
				...
				{!showAll && (
					<div className="text-center mt-12">
						<button
							className="bg-white border-2 border-[#867957] text-[#867957] px-12 py-4 rounded-xl hover:bg-[#867957] hover:text-white transition-all shadow-md hover:shadow-lg"
							style={{
								fontFamily: '"Readex Pro", sans-serif',
								fontWeight: 500,
							}}
						...
						>
							{isAr ? "عرض جميع الجولات" : "View All Tours"}
						</button>
					</div>
				)}
			</div>
