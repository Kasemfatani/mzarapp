...
function ReviewCard({ name, rating, tour, review, avatar, verified = true }) {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 group hover:scale-[1.02] border border-gray-100 relative" dir="rtl">
      {/* Quote Icon */}
      ...
      {/* Review Text */}
      <p className="text-gray-700 leading-relaxed mb-4 text-sm relative z-10 text-right" style={{ fontFamily: '"Readex Pro", sans-serif', lineHeight: '1.6' }}>
        "{review}"
      </p>
